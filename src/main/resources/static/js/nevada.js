document.addEventListener('DOMContentLoaded', function() {
    ...
    const ctx = document.getElementById('nevadaChart').getContext('2d');
    let nevadaChart;
        ...
        fetch('/api/pollings')
            ...
            .then(pollings => {
                ...
                pollings.forEach(polling => {
                    if (polling.territory.territory == 'Nevada') {
        ...
        fetch('/api/pollings')
            ...
            .then(pollings => {
                const filteredPollings = pollings.filter(polling =>
                    polling.pollster.idpollster == pollsterId && polling.territory.territory == 'Nevada'
                );
